...
This is a Gemini agent entrypoint. See [AGENTS.md](AGENTS.md) for the universal agent contract that applies to all agents including Gemini.

## Quick Reference

All Gemini agents must follow the rules defined in `AGENTS.md`. Key points:

...

{
  ...
  systemd.services."podman-channels-dvr" = {
    serviceConfig = {
      ...
      # Ensure mount directories exist before container starts
      ExecStartPre = [
        "${pkgs.coreutils}/bin/mkdir -p /mnt/prodigy/mojo/dvr/channels/config"
        "${pkgs.coreutils}/bin/mkdir -p /mnt/prodigy/mojo/dvr/channels/recordings"
      ];
    };
    startLimitBurst = 10;
    unitConfig = {
